...
export const mockTickets: Ticket[] = [
  ...
  {
    id: "TKT-004",
    title: "Sistema muy lento esta mañana",
    description:
      "Desde las 8am el sistema está extremadamente lento. Tarda más de 2 minutos en cargar cualquier página.",
    category: "soporte_tecnico",
    priority: "urgente",
    status: "en_proceso",
    clientId: "2",
  ...
  },
  {
    ...
    description:
      "Necesito exportar todos mis datos del último trimestre en formato Excel. ¿Cómo puedo hacerlo?",
